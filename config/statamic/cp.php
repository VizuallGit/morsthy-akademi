...
return [
    ...
    */
    ...
    'widgets' => [
        ['type' => 'getting_started_vizuall', 'width' => 50],
    ],
    ...
    */
    ...
    'support_url' => env('STATAMIC_SUPPORT_URL', 'https://vizuall.dk/kontakt/'),
    ...
    */
    ...
    'custom_cms_name' => env('STATAMIC_CUSTOM_CMS_NAME', 'Vizuall'),
    'custom_logo_url' => [
        'nav' => '/white-labeling-icon-dark.svg',
        'outside' => '/white-labeling-logo-cms-dark.svg'
    ],
    'custom_dark_logo_url' => [
        'nav' => '/white-labeling-logo.svg',
        'outside' => '/white-labeling-logo-cms.svg'
    ],
    'custom_logo_text' => env('STATAMIC_CUSTOM_LOGO_TEXT', 'Vizuall'),

    'custom_favicon_url' => env('STATAMIC_CUSTOM_FAVICON_URL', '/white-labeling-favicon.svg'),

    'custom_css_url' => env('STATAMIC_CUSTOM_CSS_URL', '/custom-cp.css'),
